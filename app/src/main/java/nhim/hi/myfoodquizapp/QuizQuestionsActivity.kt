...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener { // implementing view onclick listner

    private var mCurrentPosition: Int = 1
    private var mQuestionsList : ArrayList<Question>? = null
    private var mSelectedOptionPosition: Int = 0 // need to know which option was selected
    ...
    private fun defaultOptionsView()
    {
        ...
        {
            option.setTextColor(Color.parseColor("#7A8089")) // set the text color of the option
            option.typeface = Typeface.DEFAULT
            option.background = ContextCompat.getDrawable(
                this, R.drawable.default_option_boarder_bg
            )
        }
    ...
    private fun selectedOptionView(tv:TextView, selectedOptionNum : Int)
    {
        ...
        tv.background = ContextCompat.getDrawable(
            this, R.drawable.seleected_option_boarder_bg
        )
    }
                ...
                if (mSelectedOptionPosition == 0)
                {
                    ...
                    when{
                        ...
                        else ->
                        {
                            ...
                            intent.putExtra(Constants.CORRECT_ANSWERS, correctAnsNum)
